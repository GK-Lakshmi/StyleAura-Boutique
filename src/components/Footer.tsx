...
const Footer: React.FC = () => {
  return (
    <footer className="bg-aura-dark-charcoal text-white pt-12 pb-6">
        ...
        <div className="grid grid-cols-1 md:grid-cols-4 gap-8">
          ...
          <div className="col-span-1 md:col-span-1">
            ...
            <p className="text-gray-300 text-sm mt-4 text-center md:text-left">
              StyleAura offers elegant fashion pieces that capture the essence of sophistication and class.
            </p>
          ...
          <div className="col-span-1">
            ...
            <ul className="space-y-2 text-center md:text-left">
              ...
              <li>
                <Link to="/products/category/new-arrivals" className="text-gray-300 hover:text-white transition-colors">New Arrivals</Link>
              </li>
              <li>
                <Link to="/products/category/best-sellers" className="text-gray-300 hover:text-white transition-colors">Best Sellers</Link>
              </li>
              <li>
                <Link to="/products/category/sale" className="text-gray-300 hover:text-white transition-colors">Sale</Link>
              </li>
            </ul>
          </div>
          ...
          {/* Customer Service */}
          <div className="col-span-1">
            <h3 className="text-white font-semibold mb-4 text-center md:text-left">Customer Service</h3>
            <ul className="space-y-2 text-center md:text-left">
              <li>
          ...
          <div className="col-span-1">
            ...
            <div className="space-y-3 text-center md:text-left">
              ...
              <div className="flex items-center justify-center md:justify-start gap-3">
                ...
                <span className="text-gray-300">contact@styleaura.com</span>
              </div>
            </div>
          </div>
        </div>
